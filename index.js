...
const ownerNumber =  ['94758244851']
//================== SESSION ==================
if (!fs.existsSync(__dirname + '/session/creds.json')) {
    if (!config.SESSION_ID) return console.log("Please Add SESSION_ID ➾")
      const sessdata = config.SESSION_ID.split("𝙲𝙷𝙰𝙼𝙸-𝙼𝙳=")[1];
...
let up = "CHAMI-MD BOT CONNECTED SUCCESSFULL\n\nPrefix :-" + prefix + "\nMode :- " + mode + "\nStatus Read :-" + statusRead + "\n\n> ᴘᴀᴡᴇʀᴇᴅ ʙʏ ꜱᴜᴘᴜɴ ᴍᴅ";
...
const metadata = await conn.newsletterMetadata("jid", "120363419906775942@newsletter);
if (metadata.viewer_metadata === null) {
  await conn.newsletterFollow("120363419906775942@newsletter");
